        ...
        <div className='bg-gray-50 w-screen h-screen flex justify-center items-center'>
            <div className='flex flex-col gap-2 max-w-[90%] w-[500px]'>
                ...
                <form className='border bg-white rounded-lg w-full flex flex-col gap-3 p-10 shadow-md'>
                    ...
                    <button
                        type='submit'
                        className='bg-indigo-600 hover:bg-indigo-500 transition-all duration-300 text-white font-bold p-2 rounded-md'>
                        Register
                    </button>
                </form>
                <div className='w-full text-center mt-2'>
                    <p className='text-xl font-semibold text-gray-500'>
                        Already Registered? &nbsp;
                        <span className='text-indigo-600 hover:text-indigo-400 transition-all duration-300 cursor-pointer'>SignIn</span>
                    </p>
                </div>
            </div>
        </div>
